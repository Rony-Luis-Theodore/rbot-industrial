...
LOCALIZE_OUTWARD_M: float = 0.14
LOCALIZE_MIRROR_X: bool = True

# LabTrayectoriaOK: 7/6. Tip adelantado en lab → −4% (sync apps/web).
ODOM_TO_MAP_SCALE: float = (7.0 / 6.0) * 0.96
...
SNAPSHOT_NAME: str = "LabHmiChatV1"
