 ...
 *
 * CHECKPOINT VALIDADO: LabHmiStableV3 (packages/lab_map/snapshots/).
 * Ubicar 1× + ocultar botón · chat secuencias · reload = sesión limpia.
 ...
 * Para reanclar: recargar la página.
 */
export const UBICAR_ONCE_PER_SESSION = true;
/**
 * Solo dibujo: si el rumbo Occupancy está cerca de un cardinal, la flecha
 * se pinta en ese eje (corrige el “poquito a un lado” sin tocar SE2/Ubicar).
 */
export const ARROW_UI_SNAP_RAD = 0.2; // ~11.5°
...
export const ALIGN_VER = "lab-hmi-stable-v3";
export const NORTH_VER = "lab-north-v1";
export const CHECKPOINT_NAME = "LabHmiStableV3";
